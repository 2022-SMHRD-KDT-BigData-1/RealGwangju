...
<link
	href="https://cdn.jsdelivr.net/npm/booptrap@5.1.3/dist/css/booptrap.min.css"
	rel="stylesheet">
<script src="https://code.jquery.com/jquery-3.6.0.js"></script>
<title>view</title>
<link rel="stylesheet" type="text/css" href="assep/css/main.css">
</head>
<body>
	<c:set var="visit_lat" value="${pInfo.p_lat}" scope="request"></c:set>
	<c:set var="visit_lng" value="${pInfo.p_lng}" scope="request"></c:set>
	<c:set var="visit_name" value="${pInfo.p_name}" scope="request"></c:set>
	...
	<div class="container r_view">
		<div class="top_view_img">
			...
			<ul class="view_img_line">
				<li class="slide_1"><div class="view_img">${pInfo.p_ct}</div></li>
			</ul>
	...
	<script type="text/javascript">
		$('.gbtn').click(function(){
			location.href = 'LikeCon.do?p_name=${pInfo.p_name}&kind=?p';
		});
		// 조정버튼
		let a = 1;
	...
	<script
		src="https://cdn.jsdelivr.net/npm/booptrap@5.1.3/dist/js/
            booptrap.bundle.min.js">
	</script>
	<div class="view_li">
		<ul>
			<!-- 건드리지말기 -->
	...
	<div class="view_result">
		<!-- 설명 -->
		<div class="view_sul">${pInfo.p_ct}</div>
		<div class="view_map">
...
<script>
	$('.modify').click(function(){
		location.href = 'ModifyReviewCon.do?visit_name=${pInfo.p_name}';
	});
	$('.delete').click(function(){
		location.href = 'DeleteReviewCon.do?visit_name=${pInfo.p_name}';
	});
</script>
</body>
</html>