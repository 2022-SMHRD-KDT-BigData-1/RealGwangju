...
<body>
	...
	<div class="review_view">
		<div class="review_view_all">
			<p style="text-align: left; margin-left: 5%; font-size: 20px">ID
				: 작성자 아이디</p>
			...
			<p
				style="text-align: left; margin-left: 5%; margin-right: 5%; font-size: 20px; margin-top: 50px">리뷰내용이
				들어간다 리뷰내용이 들어간다 리뷰내용이 들어간다 리뷰내용이 들어간다 리뷰내용이 들어간다</p>
		</div>
	</div>
	<div class="choice_review">
		<h2>최근 게시물</h2>
		<span><a href="review.jsp">전체보기</a></span>
	</div>
