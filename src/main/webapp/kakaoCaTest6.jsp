...
<style>
	...
	#category {position:absolute;top:10px;left:10px;border-radius: 5px; width:max-content; border:1px solid #909090;box-shadow: 0 1px 1px rgba(0, 0, 0, 0.4);background: #fff;overflow: hidden;z-index: 2;}
