...
<body>
	...
	<div class="row top3">
		...
		<div class="col-md-11"><%=monthst%>의 추천테마!
		</div>
	</div>
	<hr style="color: red; height: 5px; width: 90%; margin-left: 5%;">
	<div>
	...
	<script>
		...
		document.querySelector(".pr2").addEventListener('click', function() {
			b = b + 30;
			if (b > 0) {
				b = 0
			}
		...
		document.querySelector(".nx2").addEventListener('click', function() {
			b = b - 30
			if (b < -210) {
				b = 0
		...
		document.querySelector(".pr33").addEventListener('click', function() {
			c = c + 30;
			if (c > 0) {
				c = 0
			}
		...
		document.querySelector(".pr4").addEventListener('click', function() {
			d = d + 30;
			if (d > 0) {
				d = 0
			}
		...
		document.querySelector(".nx4").addEventListener('click', function() {
			d = d - 30
			if (d < -210) {
				d = 0
